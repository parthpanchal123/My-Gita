...
import { kalam, inter } from "../../../public/fonts/Fonts"
import Link from "next/link"

export default function Try() {

	return <div className="h-screen min-w-screen bg-neutral-900 p-2">
		<section className="container relative h-3/5 m-auto">
			<div className="mt-2 rounded-md absolute inset-0  bg-cover bg-backdrop-blur bg-center" style={{ opacity: "0.7" }}></div>
		...
		<div className="container m-auto max-w-md text-center">
			<h1 className={`mt-3 text-gray-100 text-base flex ${inter.variable} font-sans font-extrabold`}>The Bhagavad Gita, a revered text of old,
